...
public class ItemRequestController {
    ...
    @PostMapping
    public ItemRequestInfoDto create(@RequestBody ItemRequestRequestingDto requestReceiveDto,
    ...
    public List<ItemRequestInfoDto> getAllWithOffsetAndLimit(@RequestHeader(name = "X-Sharer-User-Id") long requestingUserId,
        ...
        log.info("GET \"/requests/all?from={}&size={}\" , Headers:(X-Sharer-User-Id)={}", offset, limit, requestingUserId);
